...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  private final StructPublisher<Pose2d> publisher = inst
...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  public Command driveToReef(Pose2d targetAprilTagPose, boolean left){
    int distanceFromAprilTag = 1;
    ...
    return driveToPose(
      new Pose2d().transformBy(
        new Pose2d().transformBy(
          targetAprilTagPose.minus(
            new Pose2d(
              new Translation2d(distanceFromAprilTag, 0).rotateBy(
                targetAprilTagPose.getRotation().plus(
                  new Rotation2d(Units.degreesToRadians(-180))
                )
              ),
              new Rotation2d()
          ...
          new Pose2d(
            new Translation2d(distanceToSide, 0).rotateBy(
              targetAprilTagPose.getRotation().plus(
